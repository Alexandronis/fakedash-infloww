  ...
  return (
    <div className="stats-wrap" style={{ position: "relative" }}>
      <div className="stats-header">
        <h6>Creator Statistics</h6>
        <div className="metrics-and-export">
          <div className="custom-metrics-container">
            <button className="custom-metrics-button" style={{ color: "white" }}>
              <span className="icon" style={{ cursor: "pointer", display: "inline-block" }}>
                <svg width="256px" height="256px" viewBox="0 0 24.00 24.00" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#5b5252" strokeWidth="0.096">
          ...
          <span id="export-btn" className="header-span_filter" style={{cursor: "pointer"}}>
            <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="none" viewBox="0 0 24 24">
              <path stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" d="M18.796 4H5.204a1 1 0 0 0-.753 1.659l5.302 6.058a1 1 0 0 1 .247.659v4.874a.5.5 0 0 0 .2.4l3 2.25a.5.5 0 0 0 .8-.4v-7.124a1 1 0 0 1 .247-.659l5.302-6.059c.566-.646.106-1.658-.753-1.658Z"></path>
            </svg> Export
          </span>
      ...
      <div className="d-flex justify-content-between">
        ...
        <div className="card">
          <div className="card-content">
            <EditableEarningsField
              ...
              onChange={updateCreatorsCount}
              className="display-5 creator-bottom"
              currency={false}
              // OVERRIDE COLOR TO MATCH ORIGINAL (Usually Dark Grey/Black for Counts)
              style={{ color: "inherit" }}
            />
        ...
        {/* Message Earnings Card */}
        <div className="card">
          <div className="card-content">
            <p className="display-5 msg-earning-bottom">${stats.messages.toFixed(2)}</p>
            <h5 className="card-title">
              Message Earnings
              <button type="button" className="info-btn">
                <img src="/info-icon.png" alt="Info" className="info-icon" />
        ...
        <div className="card">
          <div className="card-content">
            <p className="display-5 total-earning-bottom">${stats.total.toFixed(2)}</p>
            <h5 className="card-title">
              Total Earnings
              <button type="button" className="info-btn">
                <img src="/info-icon.png" alt="Info" className="info-icon" />
        ...
        <div className="card">
          <div className="card-content">
            <EditableEarningsField
              value={stats.refundedEarnings}
              onChange={updateRefundedEarnings}
              className="display-5 refunded-bottom"
              currency={true}
              // OVERRIDE COLOR TO MATCH ORIGINAL (Refunds are usually red or black)
              style={{ color: "inherit" }}
            />
            <h5 className="card-title">
              Refunded
      ...
      <div>
        <div className="table-container" id="tableContainer">
          <table>
            ...
            <tbody>
            <tr>
              <th style={{padding: "10px 12px", textAlign: "left", fontSize: "13px", color: "rgb(153, 153, 153)", whiteSpace: "nowrap", position: "relative", fontFamily: "Calibri, sans-serif", backgroundColor: "rgb(53, 53, 53)"}}>
                <div style={{display: "flex", alignItems: "center", justifyContent: "space-between", width: "100%", cursor: "pointer", position: "relative"}}>
                  <span>Creators</span>
                  <div style={{display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: "0px", cursor: "pointer", marginLeft: "8px"}}>
                    <div title="Click to sort descending" style={{width: "14px", height: "14px", backgroundImage: 'url("/arrow11.png")', backgroundSize: "contain", backgroundRepeat: "no-repeat"}}></div>
                    <div title="Click to sort ascending" style={{width: "14px", height: "14px", backgroundImage: 'url("/arrow12.png")', backgroundSize: "contain", backgroundRepeat: "no-repeat"}}></div>
                  </div>
                </div>
              </th>
              <th style={{padding: "10px 12px", textAlign: "left", fontSize: "13px", color: "rgb(153, 153, 153)", whiteSpace: "nowrap", position: "relative", fontFamily: "Calibri, sans-serif", backgroundColor: "rgb(53, 53, 53)"}}>
        ...
        <div className="main-card-wrap charts">
          <div className="main-card-heading"></div>
